...
class EventDetailsViewScreen extends StatefulWidget {
  const EventDetailsViewScreen({super.key});

  @override
  _EventDetailsViewScreenState createState() => _EventDetailsViewScreenState();
}

class _EventDetailsViewScreenState extends State<EventDetailsViewScreen> {
